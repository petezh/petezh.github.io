...
When sampling without replacement, there are $${N \choose n}$$ possible sequences. The chance of getting $$g$$ good and $$b$$ bad elements is $$\frac{{G \choose g}{B \choose b}}{{N \choose n}}$$.
