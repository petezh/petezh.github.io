...
$$
The firm's expected profit is $$(1-p)\piq - p(\piq - q)$$ which, under zero profit, implies $$\pi = p$$, an **actuarially fair** premium. Substituting back, $$q^* = L$$ - the consumer insures all losses.
